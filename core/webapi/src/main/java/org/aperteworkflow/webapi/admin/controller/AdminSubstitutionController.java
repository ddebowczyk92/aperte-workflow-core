...
@Controller(value = "AdminSubstitutionController")
@RequestMapping("VIEW")
/**
 * Administration portlet dispatcher
 */
public class AdminSubstitutionController {
    private static final String PORTLET_JSON_RESULT_ROOT_NAME = "result";

    private static Logger logger = Logger.getLogger(AdminSubstitutionController.class.getName());
    ...
    {
        logger.fine("AdminSubstitutionController.handleMainRenderRequest... ");
