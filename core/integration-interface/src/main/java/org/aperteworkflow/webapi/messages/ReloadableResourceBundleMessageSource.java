...
package org.aperteworkflow.webapi.messages;
 ...
 * file extension or language codes, but can refer to any Spring resource location (instead of being
...
public class ReloadableResourceBundleMessageSource extends AbstractMessageSource
     ...
     */
    private final Map<String, ReloadableResourceBundleMessageSource.PropertiesHolder> cachedProperties =
            new HashMap<String, ReloadableResourceBundleMessageSource.PropertiesHolder>();
    /**
     * Cache to hold merged loaded properties per locale
     */
    private final Map<Locale, ReloadableResourceBundleMessageSource.PropertiesHolder> cachedMergedProperties =
            new HashMap<Locale, ReloadableResourceBundleMessageSource.PropertiesHolder>();
    
    /** Cache aperte OSGI properties */
    private final Map<Locale, I18NSource> cachedSources = 
    		new HashMap<Locale, I18NSource>();
     ...
     * {@link ResourceBundleMessageSource} referring to a Spring resource location: e.g.
    ...
    protected String resolveCodeWithoutArguments(String code, Locale locale) 
    {
        ...
        return resolveCodeFromI18Source(code, locale);
    }
    ...
    protected MessageFormat resolveCode(String code, Locale locale) 
    {
        ...
        /* No cached properties, try to resolve by Aperte i18Source */
	    String result = resolveCodeFromI18Source(code, locale);
        
        MessageFormat messageForamt = new MessageFormat(result, locale);
        
        return messageForamt;
    }
    
    protected String resolveCodeFromI18Source(String code, Locale locale)
    {
        I18NSource i18Source = cachedSources.get(locale);
        if(i18Source == null)
        {
	        i18Source = I18NSourceFactory.createI18NSource(locale);
	        cachedSources.put(locale, i18Source);
        }
        
        return i18Source.getMessage(code);
    }
     ...
     */
    protected ReloadableResourceBundleMessageSource.PropertiesHolder getMergedProperties(
            Locale locale) {
        synchronized (this.cachedMergedProperties) {
            ReloadableResourceBundleMessageSource.PropertiesHolder mergedHolder =
                    this.cachedMergedProperties.get(locale);
            if (mergedHolder != null) {
                return mergedHolder;
            }
            Properties mergedProps = new Properties();
            mergedHolder = new ReloadableResourceBundleMessageSource.PropertiesHolder(mergedProps,
                    -1);
    ...
    protected ReloadableResourceBundleMessageSource.PropertiesHolder refreshProperties(
            String filename, ReloadableResourceBundleMessageSource.PropertiesHolder propHolder) {
