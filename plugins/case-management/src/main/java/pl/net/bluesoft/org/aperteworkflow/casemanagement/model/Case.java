...
@NamedNativeQueries({
        @NamedNativeQuery(
                ...
                query = "select * from select_complaint_case(:caseNumber, :caseShortNumber, :personName, :pir, :flightDate, :flightDateTo, :flightDateRange, :flightNo, :assignedPerson, :in_orderBy, :ascOrder, :pageSize, :currentPage, :complaintType, :createDate, :createDateTo, :createDateRange, :categories, :stages, :textSearch)",
                resultClass = Case.class
        ),
        @NamedNativeQuery(
                name = "selectComplaintCaseCount",
                query = "select select_complaint_case_count(:caseNumber, :caseShortNumber, :personName, :pir, :flightDate, :flightDateTo, :flightDateRange, :flightNo, :assignedPerson, :complaintType, :createDate, :createDateTo, :createDateRange, :categories, :stages, :textSearch) as cnt",
