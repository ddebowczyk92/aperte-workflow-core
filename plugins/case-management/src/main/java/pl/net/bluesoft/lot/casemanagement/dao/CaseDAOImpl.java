...
import pl.net.bluesoft.lot.casemanagement.model.query.FindComplaintQueryBuilder;
import pl.net.bluesoft.rnd.processtool.hibernate.SimpleHibernateBean;

import java.math.BigInteger;
import java.util.*;

import static pl.net.bluesoft.lot.casemanagement.model.query.FindComplaintQueryBuilder.SelectComplaintCase;
