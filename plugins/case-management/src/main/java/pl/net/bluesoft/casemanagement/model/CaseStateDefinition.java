 ...
 */
@Entity
@Table(name = "pt_case_state_definition", schema = COMPLAINTS_SCHEMA)
...
public class CaseStateDefinition extends PersistentEntity {
    public static final String TABLE = COMPLAINTS_SCHEMA + "." + CaseStateDefinition.class.getAnnotation(Table.class).name();
